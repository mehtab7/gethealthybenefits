...
<body class="px-3 md:px-10 lg:px-20">
    ...
    <main class="py-10">
        <div class="">
            <h1 class="text-2xl md:text-4xl lg:text-4xl text-center md:text-left">Privacy Policy for GetHealthyBenefits</h1>

            <p>At GetHealthyBenefits, accessible from www.GetHealthyBenefits.com, one of our main priorities is the
                privacy of our visitors. This Privacy Policy document contains types of information that is collected
                and recorded by GetHealthyBenefits and how we use it.
                If you have additional questions or require more information about our Privacy Policy, do not hesitate
                to
                contact us. This Privacy Policy applies only to our online activities and is valid for visitors to our
                website with regards to the information that they shared and/or collect in GetHealthyBenefits. This
                policy
            ...
            <h2 class="text-2xl md:text-4xl lg:text-4xl text-center md:text-left">Information we collect</h2>

            <p>The personal information that you are asked to provide, and the reasons why you are asked to provide it,
                will be made clear to you at the point we ask you to provide your personal information. If you contact us directly, we may receive additional information about you such as your name, email
                address, phone number, the contents of the message and/or attachments you may send us, and any other
                information you may choose to provide. When you register for an Account, we may ask for your contact information, including items such as name,
                company name, address, email address, and telephone number.</p>

            <h2 class="text-2xl md:text-4xl lg:text-4xl text-center md:text-left">How we use your information</h2>
            ...
            <p>GetHealthyBenefits follows a standard procedure of using log files. These files log visitors when they
            ...
            <p>Like any other website, GetHealthyBenefits uses "cookies". These cookies are used to store information
            ...
            <P>You may consult this list to find the Privacy Policy for each of the advertising partners of
                GetHealthyBenefits.</p>

            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in their respective advertisements and links that appear on GetHealthyBenefits, which are sent
            ...
            <p>Note that GetHealthyBenefits has no access to or control over these cookies that are used by third-party
                advertisers.</p>

            <h2>Third Party Privacy Policies</h2>

            <p>GetHealthyBenefits's Privacy Policy does not apply to other advertisers or websites. Thus, we are
            ...
            <p>GetHealthyBenefits does not knowingly collect any Personal Identifiable Information from children under
