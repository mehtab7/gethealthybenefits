                ...
                <ul>
                    ...
                    <li class="hidden md:block">
                        <div class="dropdown inline-block relative">
                            ...
                            <div class="dropdown-menu absolute hidden bg-black text-gray-700 pt-1">
                              <div class=""><button class="rounded-t text-white py-2 px-4 block whitespace-no-wrap" href="#">One</button></div>
                              <div class=""><button class=" py-2 px-4 text-white block whitespace-no-wrap" href="#">Two</button></div>
                            ...
                            <form class="flex  items-center " action="#">
                                <div class="relative ">
                                    ...
                                    <input type="text" id="simple-search"
                                        class="bg-[#efeef0] w-full text-sm rounded-[2rem]  block  pl-10 p-2.5 placeholder:text-lg placeholder:font-medium placeholder:text-black  "
                                        placeholder="Search" required>
                                </div>
                            </form>
                            <!-- <button
                                class="text-white bg-black hover:bg-[#314bff] lg:text-[20px] transition font-medium rounded-[2rem] text-sm px-5 py-2.5">Default</button> -->
                        </div>
                    </li>
                </ul>
            </nav>
